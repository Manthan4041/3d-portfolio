...
using use = useUsing("use")`,
  ...
  name: "jwt",
  label: "JWT",
  shortDescription: "secure auth token vibes 🔐",
  color: "#000",
...
[SkillNames.REST]: {
  ...
  name: "rest",
  label: "REST API",
  shortDescription: "APIs talking clean and stateless 💬",
  color: "#000",
...
[SkillNames.SQL]: {
  ...
  name: "sql",
  label: "SQL",
  shortDescription: "structured queries doing magic 🧠",
  color: "#336791",
...
export const EXPERIENCE: Experience[] = [
{
  ...
  company: "HinduMandirPuja.in",
  description: [
    "Built a full-stack booking and donation platform enabling seamless puja scheduling and online transactions.",
    "Designed secure REST APIs with JWT authentication for user and booking management.",
    "Optimized MongoDB queries and backend workflows, improving booking efficiency by ~30%.",
    "Deployed and managed application on Vercel with focus on scalability and performance.",
  ],
  skills: [
    SkillNames.REACT,
    SkillNames.NODEJS,
...
},
{
  ...
  endDate: "Jun 2025",
  title: "Full Stack Developer",
  company: "Margdarshan IAS",
  description: [
    "Developed an EdTech platform for UPSC aspirants including course modules, test series, and performance analytics.",
    "Built responsive React interfaces for content delivery and user progress tracking.",
    "Integrated backend APIs using Node.js and worked with SQL-based data handling.",
    "Improved system performance and reliability for 150+ daily active users.",
  ],
  skills: [
    SkillNames.REACT,
    SkillNames.NODEJS,
